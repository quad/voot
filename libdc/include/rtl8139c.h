...
/* RTL8139c IO and DMA Definitions - I have intentionally left out the
    parens around idx. */
...
/* RTL8193c interrupt mask bits; OR these together and write the resulting value */
#define RTL_IMR_TIMEOUT         0x4000      /* Time Out interrupt */
#define RTL_IMR_FIFO_OVER       0x40        /* Rx FIFO overflow interrupt */
#define RTL_IMR_PUN             0x20        /* Packet Underrun interrupt */
#define RTL_IMR_LINKCHG         0x20        /* Link change interrupt */
#define RTL_IMR_DMA_OVER        0x10        /* Rx DMA buffer overflow interrupt */
#define RTL_IMR_TX_ERR          0x8         /* Transmit Error interrupt */
#define RTL_IMR_TX_OK           0x4         /* Transmit OK interrupt */
#define RTL_IMR_RX_ERR          0x2         /* Receive Error interrupt */
#define RTL_IMR_RX_OK           0x1         /* Receive OK interrupt */

/* RTL8193c command bits; OR these together and write the resulting value
...
/* 93C456 command bits; OR these together */
...
/* RTL8193c config bits; OR these together */
...
/* RTL8139c interrupt status bits - to clear an interrupt write a true back
    on the status bit */
...
bool    rtl_init        (exception_table *exp_table);
